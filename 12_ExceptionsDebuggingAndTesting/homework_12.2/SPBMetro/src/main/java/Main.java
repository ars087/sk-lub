...
public class Main {
    ...
    private static final String DATA_FILE = "D:\\skillbox\\java_basics\\12_ExceptionsDebuggingAndTesting\\homework_12.2\\SPBMetro\\src\\main\\resources\\map.json";
    ...
    private static Station takeStation(String message) {
        ...
        for (; ; ) {
            ...
            if (station != null) {
                logger.debug("Какие станции в поиске ?" + line);
                return station;
            }
            System.out.println("Станция не найдена :(");
            logger.info("Cтанция не найдена :" + line);
        }
    }
    ...
    private static void createStationIndex() {
        ...
        try {
            ...
            ex.printStackTrace();
            logger.error("Ошибка к доступу данных из файла");
        }
    }
    ...
    private static String getJsonFile() {
        ...
        try {
            ...
            ex.printStackTrace();
            logger.error("Отсутствует подключаемый файл с данными");
        }
